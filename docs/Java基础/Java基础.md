...
public final void wait() throws InterruptedException拷贝到剪贴板拷贝失败拷贝成功
```
...
```java
public native boolean isInstance(Object obj);拷贝到剪贴板拷贝失败拷贝成功
```
...
Object str = c.newInstance();拷贝到剪贴板拷贝失败拷贝成功
```
...
public Object invoke(Object obj, Object... args)
        throws IllegalAccessException, IllegalArgumentException,
           InvocationTargetException拷贝到剪贴板拷贝失败拷贝成功
```
...
![](https://gitee.com//codetigers/images/raw/master/img/20200427101659.png)
